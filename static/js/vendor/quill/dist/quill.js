    ...
    _.each(data, (function(_this) {
      return function(line) {
        ...
        if (_.isString(line)) {
          ...
          return newLine.node.innerHTML = line;
        } else {
...
Editor = (function() {
  ...
  Editor.prototype.applyDelta = function(delta, source) {
        ...
        return function() {
          ...
          _.each(delta.ops, function(op) {
            if (typeof op.attributes !== 'undefined' && op.attributes.embed) {
              inserted = _this._insertEmbedAt(index, op.attributes.type, op.attributes.data);
              return index += 1;
    ...
    if (localDelta && localDelta.ops.length > 0 && source !== Editor.sources.SILENT) {
      this.quill.emit(this.quill.constructor.events.TEXT_CHANGE, localDelta, Editor.sources.USER);
    }
    if (inserted) {
      return inserted;
    }
  ...
  Editor.prototype._insertEmbedAt = function(index, type, data) {
    var embedLine, line, offset, oldLine, _ref;
    _ref = this.doc.findLineAt(index), line = _ref[0], offset = _ref[1];
    oldLine = line;
    line = this.doc.insertEmbedBefore(document.createElement(dom.DEFAULT_EMBED_TAG), oldLine, type, data);
    this.doc.removeLine(oldLine);
    embedLine = line;
    return embedLine;
  };
  ...
  Editor.prototype._insertAt = function(index, text, formatting) {
    ...
    embedLine = false;
    this.selection.shiftAfter(index, text.length, (function(_this) {
      return function() {
...
Quill = (function(_super) {
  ...
  Quill.prototype.insertEmbed = function(type, data, index, source) {
    ...
    embed = this.editor.applyDelta(delta, source);
    return embed.node;
  };
